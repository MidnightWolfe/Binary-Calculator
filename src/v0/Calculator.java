...
public class Calculator {
	 ...
	 */
	public void run(String inputFile) throws FileNotFoundException {//Fix this method		
		//Testing separately start		
		//String [] fileArray = {"1","+","2"};//For testing with 1 op
		//String [] fileArray = {"x","+","2", "*", "2"};//For testing with 2 op
		//String [] fileArray = {"(","x","+","1",")"}; //For testing with brackets, 1 op
		//String [] fileArray = {"(","x","+","x",")","*","2"}; //For testing with multiple variables
		//String [] fileArray = {"2x"}; //testing for syntax error
		//String [] fileArray = {"(", "2","+","x"}; //testing for syntax error
		//String [] fileArray = {"c","+","1"};//testing for undefined variable
		//String [] fileArray = {"x","/","0"};//testing for dividing by 0;
		//String [] fileArray = {"x","%","0"};//testing for mod by 0;		
		//VariableTable.put("x", 1);
		...
		//System.exit(0); //Just to stop the program from running
		//Testing separately end
		...
		while(fin.hasNext()) {
			...
			//System.out.println(VariableTable); //for testing
